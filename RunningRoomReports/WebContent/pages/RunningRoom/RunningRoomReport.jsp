    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
          ...
          <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.occupancyreport"/>&nbsp;(<bean:write name="RunningRoomReportForm" property="lobby_filter"/>)</h1>            
          </div>
          <div class="inner cover">
            &nbsp;            
          </div>
						...
						<tbody>
						   ...
						   <logic:iterate name="RunningRoomReportForm" property="myrows" id="record" indexId="j">
							  <tr>
									...
									<td align="center"  ><bean:write name="record" property="checkin" />		</td>
									<td align="center"  ><bean:write name="record" property="checkin_time" />		</td>
									<td align="center"  ><bean:write name="record" property="checkout" />		</td>
									<td align="center"  ><bean:write name="record" property="checkout_time" />		</td>
									<td align="center"  ><bean:write name="record" property="rest_hrs" />		</td>
							   </tr>
