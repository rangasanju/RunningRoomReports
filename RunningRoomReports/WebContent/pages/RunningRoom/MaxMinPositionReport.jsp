    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
          ...
          <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.maxminposition"/></h1>            
          </div>
          <div class="inner cover">
            &nbsp;            
          </div>
          ...
          <div class="row">
					...
					<table class='table table-bordered table-striped table-condensed table-responsive'>
						<thead>
							<tr>
								<th>DATE</th>
								<th>MAX CREW COUNT</th>
								<th>TIME</th>
								<th>MIN CREW COUNT</th>
								<th>TIME</th>
						...
						<tbody>
						   ...
						   <logic:iterate name="RunningRoomReportForm" property="mypositions" id="record" indexId="j">
							  <tr>
								    <td align="center"  ><bean:write name="record" property="date" />		</td>									
									<td align="center"  ><bean:write name="record" property="max_count" />		</td>
									<td align="center"  ><bean:write name="record" property="max_hour" />		</td>
									<td align="center"  ><bean:write name="record" property="min_count" />		</td>
									<td align="center"  ><bean:write name="record" property="min_hour" />		</td>
