    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
          ...
          <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.restposition"/></h1>            
          </div>
          <div class="inner cover">
            &nbsp;            
          </div>
          ...
          <div class="row">
					...
					<table class='table table-bordered table-striped table-condensed table-responsive'>
						...
						<tbody>
						   ...
						   <logic:iterate name="RunningRoomReportForm" property="restpositions" id="record" indexId="j">
							  <tr>
								    <td align="center"  ><bean:write name="record" property="date" />		</td>									
									<td align="center"  ><bean:write name="record" property="r1_4" />		</td>
									<td align="center"  ><bean:write name="record" property="r4_6" />		</td>
									<td align="center"  ><bean:write name="record" property="r6_8" />		</td>
									<td align="center"  ><bean:write name="record" property="r8_10" />		</td>
									<td align="center"  ><bean:write name="record" property="r10_12" />		</td>
									<td align="center"  ><bean:write name="record" property="r12_14" />		</td>
									<td align="center"  ><bean:write name="record" property="r14_16" />		</td>
									<td align="center"  ><bean:write name="record" property="r16_above" />		</td>
